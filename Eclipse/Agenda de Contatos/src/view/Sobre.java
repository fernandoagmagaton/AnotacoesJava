...
public class Sobre extends JDialog {
	...
	public Sobre() {
		...
		lblNewLabel.setBounds(29, 40, 227, 27);
		getContentPane().add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("Autor: Eduardo Casagrande de Sá");
		lblNewLabel_1.setBounds(29, 87, 227, 14);
		getContentPane().add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("Sob a licença MIT");
		lblNewLabel_2.setBounds(28, 112, 168, 14);
		getContentPane().add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("New label");
		lblNewLabel_3.setIcon(new ImageIcon(Sobre.class.getResource("/img/mit-icon.png")));
		lblNewLabel_3.setBounds(275, 121, 128, 98);
